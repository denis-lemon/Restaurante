...
<main>
    ...
    <form name="perfil" action="update-funcionario" method="post" enctype="application/x-www-form-urlencoded">
        <div class="itemDados">
            ...
            <input type="password" id="password" name="password" value="<%=funcionario.getPassword() %>" required><br>
            <div class="gap"></div>
            <label for="id" type="text" class="campo">ID: </label>
            <input type="text" id="id" name="id" value="<%=funcionario.getId() %>" readonly><br>
